    ...
    <body>
        ...
        <div style="display: flex; flex-wrap: wrap; width: 100%; justify-content: space-around">
            <div class="video" style="width: 640px">
                ...
                <video id="input-video" crossorigin="anonymous"  width="640px" height="640px" style="object-fit : fill; "></video>
            </div>

            <div class="video" style="width: 640px">
                <p class="videoTitle">Detect Result</p>
                <div style="position: relative;">
                    <video id="output-video" crossorigin="anonymous"  width="640px" height="640px" style="object-fit : fill; position: absolute; right: 0; top: 0;" muted="true"></video>
        ...
        <script type="module">         
            import {YOLO_CLASSES, COLORS} from "./webcam-object-detection-node/constants.js";
